...
Во время проверки выполнения команд по методичке наткнулся на проблему - клиент не мог достучаться до сервера. Потупил, увидел, что при добавлении в аыефи указан неверный адрес, поправил - все отработало.
